...
const UserAccountDetails = ({ProfileInfo}) => {
    ...
    let handleNewSignature = () => {
      dispatch(setNewSignature({
        signatureImg: result && result || ProfileInfo.signatureImg,
                ...
                <Col>
                  <Form>
                    ...
                    <Row form>
                      {/* Email */}
                      <Col md="6" className="form-group">
                        <label htmlFor="feEmail">ელ-ფოსტა</label>
                        <FormInput
                          type="email"
                          id="feEmail"
                      ...
                      <Col md="4" id={'col-withoud-padding'}>
                        <FormTextarea
                          style={{
                            ...
                            backgroundImage: `url(${result ? result : ProfileInfo.signatureImg && ProfileInfo.signatureImg})`,
