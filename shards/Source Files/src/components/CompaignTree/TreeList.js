...
import {getAddressBook} from "../../Reducers/addNewPost/AddressBooksReducer";
import AddressBookTree from './addressBook'
...
const TreeList = (props) => {
  ...
  let AddressBook = useSelector((state => state.AddressBook.addressBook))
            ...
            <div className="mt-3">
              <div className="row mt-3 d-flex  ml-1">
                <div className="text-left text-dark">
                  ...
                  />
                  {
                    props.isAddressBook === true &&
                    <AddressBookTree
                      AddressBook={AddressBook}
                      handleSetNodeValue={props.handleSetNodeValue}
                      handleSetNodeValueForBook={props.handleSetNodeValueForBook}
                    />
                  }
                </div>
              </div>
